    ...
    <section className="relative min-h-[90vh] flex flex-col justify-center pt-12 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--accent-primary)]/10 border border-[var(--accent-primary)]/25 text-[var(--accent-primary)] text-xs font-mono transition-all duration-300">
        ...
        <div className="max-w-5xl space-y-4">
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight text-white leading-[1.08]">
            Architecting <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--accent-primary)] via-[var(--accent-secondary)] to-white">resilient systems</span> &amp; intuitive interfaces.
          </h1>
        ...
        <div className="flex flex-wrap items-center gap-4 pt-8">
          <Link
            href="/work"
            className="px-7 py-3.5 rounded-xl bg-[var(--accent-primary)] hover:opacity-90 text-black font-semibold text-sm transition-all shadow-lg shadow-[var(--accent-primary)]/20 hover:-translate-y-0.5 flex items-center gap-2"
            data-cursor="EXPLORE"
          >
          ...
          <button
            ...
            className="px-5 py-3.5 rounded-xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.08] text-neutral-300 hover:text-[var(--accent-primary)] font-mono text-xs transition-all flex items-center gap-2"
            data-cursor="CLI"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-16 mt-12 border-t border-white/[0.08]">
          ...
          <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.06]">
            ...
            <div className="text-xl sm:text-2xl font-bold text-[var(--accent-primary)] mt-1">&lt; 50ms State Sync</div>
